...
class Ebizmarts_Autoresponder_Block_Adminhtml_Unsubscribe_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        //fix
        parent::__construct();
        $this->setId('unsubscribe_customers_grid');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('mc_campaign_id', array(
            'header'=> Mage::helper('monkey')->__('List #'),
            'width' => '80px',
        ...
        $this->addColumn('created_at', array(
            'header'=> Mage::helper('monkey')->__('Unsubscribed'),
            'width' => '80px',
            'index' => 'created_at',
            'type'  => 'datetime'
        ));

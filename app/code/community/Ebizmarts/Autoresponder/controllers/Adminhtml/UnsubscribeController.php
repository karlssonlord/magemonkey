 ...
 */
class Ebizmarts_Autoresponder_Adminhtml_UnsubscribeController extends Mage_Adminhtml_Controller_Action {
    ...
    public function indexAction() {
        ...
        $this->loadLayout();
        $this->_setActiveMenu('newsletter/ebizmarts_autoresponder');
        $this->renderLayout();
    }
    ...
    public function gridAction() {
        ...
        $this->getResponse()->setBody(
                $this->getLayout()->createBlock('ebizmarts_autoresponder/adminhtml_unsubscribe_grid')->toHtml()
        );
    }
...
//    }
    ...
    public function massDeleteAction() {
        ...
        if (!is_array($orderIds)) {
            ...
            try {
                $ecommerce = Mage::getModel('ebizmarts_autoresponder/unsubscribe');
                foreach ($orderIds as $orderId) {
